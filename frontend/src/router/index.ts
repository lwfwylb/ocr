...
import QueueDispatchView from '../views/QueueDispatchView.vue'
  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'tasks/queue-dispatch', component: QueueDispatchView, meta: { title: '队列调度' } },
        ...
        { path: 'push-records', component: PushRecordsView, meta: { title: '推送记录' } },
        { path: 'models/ocr', component: OcrEnginesView, meta: { title: 'OCR 引擎' } },
        { path: 'models/llm', component: LlmConfigsView, meta: { title: 'LLM 配置' } },
        { path: 'models/prompts', component: PromptTemplatesView, meta: { title: '提示词模板' } },
