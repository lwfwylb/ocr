...
export const timeline = [
  { stage: '已创建', time: '09:30:00', description: '用户手工上传划款指令。' },
  { stage: '解析中', time: '09:30:08', description: '使用 PaddleOCR-VL 解析 PDF。' },
  { stage: '提取中', time: '09:30:16', description: '调用 Qwen3.6-27B 生成结构化 JSON。' },
  { stage: '校验中', time: '09:30:21', description: '金额、账号字段触发复核策略。' },
  { stage: '待复核', time: '09:30:25', description: '低置信度字段等待人工确认。' }
]
