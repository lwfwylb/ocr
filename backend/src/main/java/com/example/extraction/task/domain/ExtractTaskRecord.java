...
public class ExtractTaskRecord {
    private String id;
    ...
    private String manualAccelerated;
    ...
    public String getManualAccelerated() { return manualAccelerated; }
    public void setManualAccelerated(String manualAccelerated) { this.manualAccelerated = manualAccelerated; }
